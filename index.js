...
var regex_default = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|70d0df24-4316-4616-9f73-47b7f7100cfd)$/i;
...
var cf_worker_vless_default = {
  async fetch(request, env, ctx) {
    ...
    const userID = env.UUID || "00fdxxxd-81xx-xx54-bxx2-b6xxx2aXXXXX";
